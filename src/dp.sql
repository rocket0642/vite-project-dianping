...
CREATE TABLE `tb_after_sale`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT COMMENT '售后ID',
  `order_id` bigint(0) NOT NULL COMMENT '关联订单ID',
  `user_id` bigint(0) NOT NULL COMMENT '用户ID',
  `shop_id` bigint(0) NOT NULL COMMENT '店铺ID',
  `type` tinyint(0) NOT NULL COMMENT '售后类型：1-退款/2-退货退款',
  `reason` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '退款原因',
  `amount` bigint(0) NOT NULL COMMENT '退款金额（分）',
  `description` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '问题描述',
  `images` varchar(2048) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '图片凭证，最多5张，逗号分隔',
  `status` tinyint(0) NOT NULL DEFAULT 1 COMMENT '售后状态：1-待处理/2-处理中/3-已完成/4-已拒绝',
  `handle_msg` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '处理备注',
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '商品评价表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `tb_goods`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_shop_id`(`shop_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2407 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;
...
) ENGINE = InnoDB AUTO_INCREMENT = 65 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '订单商品明细表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `tb_user`  (
  ...
  `create_time` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0) COMMENT '更新时间',
  `is_admin` tinyint(1) NOT NULL DEFAULT 0 COMMENT 'root',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uniqe_key_phone`(`phone`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1028 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;
